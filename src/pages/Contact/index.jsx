...
item1.URL:https://www.linkedin.com/in/jason-brooks-32222539b/
    ...
    <div className="card">
      ...
      <div className="card-body">
        ...
        <a href="https://jason-brooks-portfolio.vercel.app" className="contact-item">
          <div className="contact-icon">
            <svg viewBox="0 0 24 24"><path d="M12 2L1 21h22L12 2zm0 3.84L20.93 19H3.07L12 5.84z"/></svg>
          </div>
          <div className="contact-info">
        ...
        <a href="https://www.linkedin.com/in/jason-brooks-32222539b/" className="contact-item">
          <div className="contact-icon">
            <svg viewBox="0 0 24 24"><path d="M6.94 6.5c0 .97-.78 1.75-1.75 1.75S3.44 7.47 3.44 6.5 4.22 4.75 5.19 4.75s1.75.78 1.75 1.75zM4 8.75h2.38V20H4V8.75zm5.06 0h2.28v1.53h.03c.32-.6 1.1-1.23 2.27-1.23 2.43 0 2.88 1.6 2.88 3.68V20h-2.38v-5.5c0-1.31-.02-3-1.83-3-1.83 0-2.11 1.43-2.11 2.9V20H9.06V8.75z"/></svg>
          </div>
          <div className="contact-info">
        ...
        <a href="https://github.com/JKBrooksDev" className="contact-item">
          <div className="contact-icon">
            <svg viewBox="0 0 24 24"><path d="M12 .5C5.65.5.5 5.65.5 12c0 5.1 3.29 9.43 7.86 10.96.58.11.79-.25.79-.56v-2.17c-3.2.69-3.87-1.54-3.87-1.54-.53-1.34-1.29-1.7-1.29-1.7-1.06-.72.08-.71.08-.71 1.17.08 1.78 1.2 1.78 1.2 1.04 1.78 2.73 1.27 3.4.97.11-.75.41-1.27.74-1.56-2.55-.29-5.23-1.28-5.23-5.7 0-1.26.45-2.29 1.19-3.1-.12-.29-.52-1.46.11-3.04 0 0 .97-.31 3.18 1.18a11.1 11.1 0 0 1 5.8 0c2.2-1.49 3.17-1.18 3.17-1.18.63 1.58.23 2.75.11 3.04.74.81 1.18 1.84 1.18 3.1 0 4.43-2.69 5.41-5.25 5.69.42.36.8 1.09.8 2.2v3.26c0 .31.21.67.8.56A10.99 10.99 0 0 0 23.5 12C23.5 5.65 18.35.5 12 .5z"/></svg>
          </div>
          <div className="contact-info">
      ...
      <div className="qr-section">
        ...
        <button className="save-btn" onClick={() => window.downloadVCard()}>
          Download Contact
        </button>
